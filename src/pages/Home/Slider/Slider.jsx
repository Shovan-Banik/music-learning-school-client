    ...
    return (
        <Carousel autoPlay>
            <div>
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center bg-black bg-opacity-50 text-white md:p-4">
                    <h2 className="md:text-5xl text-2xl font-bold">Welcome To Music School</h2>
            ...
            <div>
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center bg-black bg-opacity-50 text-white md:p-4">
                    <h2 className="md:text-5xl text-2xl font-bold "> Discover the Language of Music</h2>
                    <hr className="w-1/4 mx-auto my-4 hidden md:block"/>
            ...
            <div>
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center bg-black bg-opacity-50 text-white md:p-4">
                    <h2 className="md:text-5xl text-2xl font-bold  ">Unleash Your Musical Talent</h2>
                    <hr className="w-1/4 mx-auto my-4 hidden md:block"/>
            ...
            <div>
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center bg-black bg-opacity-50 text-white md:p-4">
                    <h2 className="md:text-5xl text-2xl font-bold ">Find Your Groove with Us</h2>
                    <hr className="w-1/4 mx-auto my-4 hidden md:block"/>
