...
const ExtraSection = () => {
    return (
        <div className='backImg md:bg-cover md:h-[80vh] mb-12 md:my-24 flex items-center'>
            <div className='p-12'>
                <div className='text-center my-16 p-12 bg-black opacity-60'>
                    <Marquee>
                        <h2 className='md:text-4xl text-2xl font-bold text-white py-12'>Learn to Play Your Favorite Instrument</h2>
                    </Marquee>
