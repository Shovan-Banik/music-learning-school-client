...
const ExtraSection = () => {
    return (
        <div className='backImg md:bg-cover md:h-[80vh] my-12 md:my-24'>
            <div className='p-12'>
                <div className=' text-left md:text-center mt-20 p-12 bg-black opacity-60'>
                    <Marquee><h2 className='md:text-4xl text-2xl font-bold text-white py-5'>Learn The Music From The Core & Become Mastery</h2></Marquee>
