...
const ManageClasses = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Music School | Dashboard | Manage Classes</title>
            </Helmet>
            <div>
                        ...
                        <tbody>
                            {
                                allClasses.map((singleClass, index) => <tr key={singleClass._id}>
                                    ...
                                    <td><button onClick={() => handleFeedback(singleClass)} disabled={singleClass.status=== 'approved' || singleClass.status==='pending'} className="btn btn-xs  btn-neutral ">Feedback</button></td>
                                </tr>)
                            }
                        </tbody>
                    </table>
